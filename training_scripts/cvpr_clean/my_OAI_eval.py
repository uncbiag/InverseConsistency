...
for test_pair_path in test_pair_paths:
    ...
    # test_pair_path[0] = test_pair_path[0].replace("/name-raid/name/Data/OAI_segmentation/Nifti_rescaled/", "/name-raid2/raul/DATASETS/OAI/192x192x80/")
    # test_pair_path[1] = test_pair_path[1].replace("/name-raid/name/Data/OAI_segmentation/Nifti_rescaled/", "/name-raid2/raul/DATASETS/OAI/192x192x80/")
    # test_pair_path[2] = test_pair_path[2].replace("/name-raid/name/Data/OAI_segmentation/Nifti_rescaled/", "/name-raid2/raul/DATASETS/OAI/192x192x80/")
    # test_pair_path[3] = test_pair_path[3].replace("/name-raid/name/Data/OAI_segmentation/Nifti_rescaled/", "/name-raid2/raul/DATASETS/OAI/192x192x80/")
    ...
    # create new data
    if not os.path.exists("/name-raid2/raul/DATASETS/OAI/192x192x80_FLIP_RIGHT"):
        os.makedirs("/name-raid2/raul/DATASETS/OAI/192x192x80_FLIP_RIGHT")
    ...
    # itk.imwrite(itk.GetImageFromArray(img_tensor_A.squeeze()), "/name-raid2/raul/DATASETS/OAI/192x192x80_FLIP_RIGHT/{}".format(os.path.basename(test_pair_path[0])))
